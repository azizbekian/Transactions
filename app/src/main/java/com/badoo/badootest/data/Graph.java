...
public class Graph<T> {
     ...
     */
    public boolean addEdge(Vertex<T> from, Vertex<T> to, float cost) throws IllegalArgumentException {
...
class Edge<T> {
     ...
     */
    public Edge(Vertex<T> from, Vertex<T> to, float cost) {
        this.from = from;
        this.to = to;
        this.cost = cost;
        mark = false;
...
class Vertex<T> {
     ...
     * @param dest -
     *          the destination vertex.
     * @return Return Float.MAX_VALUE if we have no edge to dest, 0 if dest is
     *         this vertex, the cost of the outgoing edge otherwise.
     */
    public float cost(Vertex<T> dest) {
        if (dest == this)
            return 0;
    ...
    public boolean equals(Object o) {
        ...
        if (markState != vertex.markState) return false;
        if (incomingEdges != null ? !incomingEdges.equals(vertex.incomingEdges) : vertex.incomingEdges != null)
            return false;
